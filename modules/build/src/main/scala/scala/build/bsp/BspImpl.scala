...
final class BspImpl(
  ...
  ): Either[(BuildException, ProjectName), PreBuildProject] = either[(BuildException, ProjectName)] {
  ...
  private def buildE(
    ...
    def doBuildOnce(data: PreBuildData, scope: Scope): Either[(BuildException, ProjectName), Build] =
      Build.buildOnce(
