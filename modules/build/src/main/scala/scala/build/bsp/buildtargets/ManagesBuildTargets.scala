...
trait ManagesBuildTargets {
  ...
  def addTarget(projectName: ProjectName, workspace: os.Path, scope: Scope, generatedSources: Seq[GeneratedSource] = Nil): Unit
...
object ManagesBuildTargets {
   ...
   * @originalSources - paths of sources seen by the user */
